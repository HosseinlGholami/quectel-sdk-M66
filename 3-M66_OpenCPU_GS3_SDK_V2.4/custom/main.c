...
{
 Ql_PWM_Init(0,PWMSOURCE_13M,PWMSOURCE_DIV1,100,300);
 Ql_PWM_Init(1,PWMSOURCE_13M,PWMSOURCE_DIV1,100,300);
 Ql_PWM_Init(2,PWMSOURCE_13M,PWMSOURCE_DIV1,100,300);
 Ql_PWM_Init(3,PWMSOURCE_13M,PWMSOURCE_DIV1,100,300);
 Ql_PWM_Init(4,PWMSOURCE_13M,PWMSOURCE_DIV1,100,300);
}
